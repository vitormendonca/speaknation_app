...
const List<ListeningExercise> listeningExercises = [
  ...
  ListeningExercise(
    ...
    level: 'A1',
    audioPath: 'audio/at_the_cafe.mp3',
    transcript:
  ...
  ListeningExercise(
    ...
    questions: [
      ...
      ActivityQuestion(
        ...
        type: QuestionType.dictation,
        question: 'Listen and type this sentence: My brother is twelve years old.',
        options: [],
  ...
  ListeningExercise(
    ...
    level: 'A1',
    audioPath: 'audio/weekend_plans.mp3',
    transcript:
    ...
    questions: [
      ...
      ActivityQuestion(
        ...
        type: QuestionType.dictation,
        question: 'Listen and type this sentence: Sarah wants to go to the park.',
        options: [],
  ...
  ListeningExercise(
    ...
    description: 'Review daily routine, café, family, school, and weekend plans.',
    level: 'A1 Review',
    audioPath: 'audio/listening_a1_review_1.mp3',
    transcript:
